  ...
  return [
    {
      ...
      displayPath: '~/Documents/Resolume Arena/Extra Effects',
      exists: true,
      writable: true,
    ...
    },
    {
      ...
      displayPath: '/Library/OFX/Plugins',
      exists: ofx !== 'missing',
      writable: ofx === 'ok',
    ...
    },
    {
      ...
      displayPath: '/Library/Application Support/Adobe/Common/Plug-ins/7.0/MediaCore',
      exists: true,
      writable: false,
      needsElevation: true,
      custom: false,
    ...
    // show a padlock the real app never shows.
    {
      ...
      displayPath: '~/Library/Audio/Plug-Ins/VST3',
      exists: true,
      writable: true,
      needsElevation: false,
      custom: false,
    },
    {
      ...
      displayPath: '~/Library/Audio/Plug-Ins/Components',
      exists: true,
      writable: true,
      needsElevation: false,
      custom: false,
    ...
    },
    {
      ...
      displayPath: '~/Documents/Companion Modules',
      exists: false,
      writable: true,
      needsElevation: false,
      custom: false,
